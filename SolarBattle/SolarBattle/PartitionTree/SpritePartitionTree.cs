...
{
    //Partition Tree to partion sprites to different areas of map for reduced collision checks, and draws
    public class SpritePartitionTree<T> where T : Sprite
    {
        //Partition section
        ...
        public SpritePartitionTree<T> parentPartition;
        public SpritePartitionTree<T> leftTopPartition;
        public SpritePartitionTree<T> rightTopPartition;
        public SpritePartitionTree<T> leftBottomPartition;
        public SpritePartitionTree<T> rightBottomPartition;
        //objects contained within current node
       ...
       // private static Dictionary<Rectangle, Rectangle> m_quadRectangleMap = new Dictionary<Rectangle, Rectangle>();
        ...
        public SpritePartitionTree( Rectangle boundingBox)
        {
        ...
        private SpritePartitionTree(Rectangle boundingBox, SpritePartitionTree<T> parent)
        {
            partitionBox = boundingBox;
            m_itemList = new LinkedList<T>();
      ...
      /*  public List<Rectangle> GetQuadRectangles()
        ...
        private void Split()
        {
            ...
            leftTopPartition = new SpritePartitionTree<T>(new Rectangle(partitionBox.Left, partitionBox.Top, midLength, midHeight), this);
            rightTopPartition = new SpritePartitionTree<T>(new Rectangle(partitionBox.Left + midLength, partitionBox.Top, midLength, midHeight), this);
            leftBottomPartition = new SpritePartitionTree<T>(new Rectangle(partitionBox.Left, partitionBox.Bottom - midHeight, midLength, midHeight), this);
            rightBottomPartition = new SpritePartitionTree<T>(new Rectangle(partitionBox.Left + midLength, partitionBox.Bottom - midHeight, midLength, midHeight), this);
